...
const Login = () => {
  ...
  return (
    <ThemedView style={{paddingTop:100}} safe={true}>
      
        <View style={{paddingHorizontal:20}}>

            <Image source={telehealth} style={{resizeMode:"contain", width:"40%"}}></Image>
            ...
            <View style={styles.forgotContainer}>
                ...
                <Link href="/forgotPassword" style={styles.link}><ThemedText link={true} >username</ThemedText></Link>
                <ThemedText>
                    or
                </ThemedText>
                <Link href="/forgotPassword" style={styles.link}><ThemedText link={true} >password</ThemedText></Link>
            </View>

            <ThemedBiometrics style={{marginTop: 20}}></ThemedBiometrics>
           
            <Link href="/" style={{marginTop: 20, color: '#2ec4b6'}}>Go Home</Link>
